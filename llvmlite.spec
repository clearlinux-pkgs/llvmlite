...
Version  : 0.27.0
Release  : 20
URL      : https://github.com/numba/llvmlite/archive/v0.27.0.tar.gz
Source0  : https://github.com/numba/llvmlite/archive/v0.27.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1546096515
export CC=clang
export CXX=clang++
export LD=ld.gold
unset LDFLAGS
