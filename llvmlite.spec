...
%prep
%setup -q -n llvmlite-0.31.0
cd %{_builddir}/llvmlite-0.31.0
%patch1 -p1
%patch2 -p1
...
cp %{_builddir}/llvmlite-0.31.0/LICENSE %{buildroot}/usr/share/package-licenses/llvmlite/55c607b2a9efc5324451d2fc8a1ff473a2aae643
