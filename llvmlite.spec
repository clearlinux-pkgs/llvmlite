...
Version  : 0.32.0
Release  : 40
URL      : https://github.com/numba/llvmlite/archive/v0.32.0/llvmlite-0.32.0.tar.gz
Source0  : https://github.com/numba/llvmlite/archive/v0.32.0/llvmlite-0.32.0.tar.gz
...
%prep
%setup -q -n llvmlite-0.32.0
cd %{_builddir}/llvmlite-0.32.0
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587057530
...
cp %{_builddir}/llvmlite-0.32.0/LICENSE %{buildroot}/usr/share/package-licenses/llvmlite/55c607b2a9efc5324451d2fc8a1ff473a2aae643
